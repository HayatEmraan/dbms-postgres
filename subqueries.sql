...
CREATE TABLE employees (
    employee_id SERIAL PRIMARY KEY, employee_name VARCHAR(50) NOT NULL, department_name VARCHAR(50), salary DECIMAL(10, 2), hire_date DATE
);
...
SELECT (SELECT SUM(salary) FROM employees) AS total_salary_cost, * FROM employees;